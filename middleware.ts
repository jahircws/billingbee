...
const PUBLIC_PREFIXES = ["/pay/", "/blog/", "/free-invoice-", "/generate", "/api/webhooks/", "/api/auth/forgot-password", "/api/auth/reset-password", "/api/auth/phone/", "/portal/", "/api/cron/", "/api/track/", "/api/tools/", "/api/unsubscribe", "/unsubscribe"]
...
export default auth(async (req) => {
  ...
  if (pathname.startsWith("/portal/")) {
    ...
    if (/^\/portal\/[^/]+\/(login|forgot-password|reset-password|open|access)/.test(pathname)) return NextResponse.next()
