...
const securityHeaders = [
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://lumberjack.razorpay.com https://checkout.razorpay.com https://www.paypal.com https://www.google.com https://www.gstatic.com https://apis.google.com https://www.googletagmanager.com https://googleads.g.doubleclick.net",
      ...
      "connect-src 'self' https://api.stripe.com https://lumberjack.razorpay.com https://api.razorpay.com https://www.paypal.com https://*.supabase.co wss://*.supabase.co https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://www.googleapis.com https://analytics.google.com https://stats.g.doubleclick.net https://ad.doubleclick.net https://www.google.com https://www.google.co.in",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
