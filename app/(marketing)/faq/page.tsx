...
export const metadata: Metadata = {
  ...generatePageMetadata(
    ...
    "Answers to common questions about BillingBee invoicing, GST compliance, payments, plans, and data security.",
    "/faq",
    { keywords: ["BillingBee FAQ", "invoice software questions", "GST invoicing help", "billing app support"] }
  ),
  other: {
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Yes! BillingBee has a free plan that lets you create up to 5 invoices per month with PDF download and GST calculations. No credit card required.",
          },
        },
        {
          "@type": "Question",
          name: "Is BillingBee GST compliant?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Yes. Every invoice generated by BillingBee includes CGST/SGST split, GSTIN fields, proper invoice numbering, and is compliant with Indian GST rules.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "BillingBee supports Razorpay (UPI, cards, net banking, wallets) and Stripe. Payment links are automatically included in every invoice.",
          },
        },
        {
          "@type": "Question",
          name: "Can I accept UPI payments?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Yes. Through our Razorpay integration, your clients can pay via UPI, credit/debit cards, net banking, and wallets like Paytm and PhonePe.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Just describe the work in plain English — e.g. 'Invoice Acme Corp ₹25,000 for web design, due in 15 days'. The AI extracts client details, amounts, GST rates, and due dates automatically.",
          },
        },
        {
          "@type": "Question",
...
const FAQS = [
  {
    ...
    a: "Yes! The free plan includes up to 5 invoices/month, PDF downloads, and GST calculations. No credit card required. Upgrade to Pro for unlimited invoices and AI collections.",
  },
  {
    q: "Is BillingBee GST compliant?",
    a: "Absolutely. Every invoice includes CGST/SGST split, GSTIN field, HSN/SAC codes, and sequential invoice numbering — fully compliant with Indian GST rules. You can export GST reports for your CA.",
  },
  {
    q: "Which payment gateways does BillingBee support?",
    a: "BillingBee supports Razorpay (UPI, cards, net banking, wallets) and Stripe. Every invoice includes a payment link — your clients click, pay, and you get notified instantly.",
  },
  {
    q: "How does the AI invoice creation work?",
    a: "Just describe the work in plain English: \"Invoice Acme Corp ₹25,000 for web design, due in 15 days.\" AI extracts the client, amount, GST rate, and due date — and creates a professional invoice in seconds.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. You can add your logo, custom colours, business address, GSTIN, bank details, and payment terms. Pro and Business plans support custom branding on the client portal.",
  },
  {
